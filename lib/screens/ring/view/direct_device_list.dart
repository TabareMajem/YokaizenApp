...
class DirectDeviceList extends StatelessWidget {
  final RingController controller;
  
  const DirectDeviceList({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    // Set controller scan results (commented out since we're not using the controller's results)
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Select your device from the list below'.tr,
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final deviceName = device['name'] ?? 'Unknown Device'.tr;
                    ...
                    onTap: () async {
                      ...
                      try {
                        ...
                        if (success == false) {
                          ...
                          controller.connectionError.value = 'Failed to connect to the device. Please try again.'.tr;
                        }
                      } catch (e) {
                        // Show error
                        controller.hasConnectionError.value = true;
                        controller.connectionError.value = 'Error connecting: ${e.toString()}'.tr;
...
// Direct function to show device list without any complex logic or scanning
void showDirectDeviceList(BuildContext context, RingController controller) {
  showDialog(
    context: context,
    barrierDismissible: false,
    builder: (BuildContext context) {
      return DirectDeviceList(controller: controller);
    },
  );
} 